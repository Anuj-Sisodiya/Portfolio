...
import { TerminalIcon, User, Briefcase, Code, Mail, Shield } from "lucide-react"
        ...
        output: (
          <div className="space-y-2">
            ...
            <p className="font-mono text-white">
              Welcome to Anuj Pratap Singh's software developer portfolio! Type help to see available commands.
            </p>
          </div>
        ),
        timestamp: new Date(),
        ...
        output = (
          <div className="space-y-2 text-white">
            ...
            <ul className="space-y-1">
              <li>
                <span className="text-white font-bold">about</span> - Learn about Anuj
              </li>
              <li>
